...
public class TeaDeal extends HttpServlet {

    /**
     * 
     */
    private static final long serialVersionUID = -1433537344369385445L;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            list.add(spe);
            Label label0 = new Label("老  师：", StyleConst.ALIGN_LEFT);
            Label label1 = new Label(user.getUser_name(), StyleConst.ALIGN_LEFT);
            Label label2 = new Label("   ", StyleConst.ALIGN_LEFT);
            Label label3 = new Label("   ", StyleConst.ALIGN_LEFT);
            Label label4 = new Label("邮  箱：", StyleConst.ALIGN_LEFT);
            Label label5 = new Label(user.getUser_email(), StyleConst.ALIGN_LEFT);
            Label label6 = new Label("   ", StyleConst.ALIGN_LEFT);
            Label label7 = new Label("   ", StyleConst.ALIGN_LEFT);
            Label label8 = new Label("联系电话：", StyleConst.ALIGN_LEFT);
            Label label9 = new Label(user.getUser_phone(), StyleConst.ALIGN_LEFT);
            Label label10 = new Label("   ", StyleConst.ALIGN_LEFT);
            Label label11 = new Label("   ", StyleConst.ALIGN_LEFT);
            Label label12 = new Label("联系QQ：", StyleConst.ALIGN_LEFT);
            Label label13 = new Label(user.getUser_qq(), StyleConst.ALIGN_LEFT);
            Label label14 = new Label("   ", StyleConst.ALIGN_LEFT);
            Label label15 = new Label("   ", StyleConst.ALIGN_LEFT);
            ...
            Table table = new Table(4, new Label("师道尊严", StyleConst.COMMONTITLE), contents, 0);
            list.add(table);
            ...
            Table table3 = new Table(1, new Label("片言之赐，皆铭于心", StyleConst.COMMONTITLE), contents3, 0);
            list.add(table3);

            list.add(new Label("时间：  "
